...
import FinancialPage from "@/components/reports/FinancialPage";
    ...
    return (
        <div className="">
            ...
            <header className="px-4 py-2">
                <div className="mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Revenue, Expenses & Analytics Overview</p>
                    </div>
            ...
            <main className="mx-auto px-4 py-4">
                <FinancialPage dateRange={dateRange} />
            </main>
        </div>
    );
};
