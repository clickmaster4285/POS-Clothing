...
import SalesSummaryPage from "@/components/reports/SalesSummaryPage";
    ...
    return (
        <div className="">
            ...
            <div className="flex items-center text-xs text-muted-foreground gap-1 px-4 py-2">
                ...
                <span className="text-primary font-medium">Sales Summary</span>
            </div>
            ...
            <header className="px-4 py-2">
                <div className="mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Overview of Sales, Revenue & Transactions</p>
                    </div>
            ...
            <main className="mx-auto px-4 py-4">
                <SalesSummaryPage dateRange={dateRange} />
            </main>
        </div>
    );
};
