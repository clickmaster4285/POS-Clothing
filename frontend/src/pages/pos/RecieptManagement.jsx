                    ...
                    <div className="bg-card rounded-lg border p-4 sm:p-6">
                        ...
                        <div className="bg-muted/50 rounded-lg p-4 sm:p-6">
                            <div className="text-center mb-4">
                                <p className="font-bold text-sm sm:text-base mb-1">TechStore Plus</p>
                                <p className="text-xs text-muted-foreground">123 Commerce St, City, ST 12345</p>
...
export default ReciptManagement;